...
resolved_at: 2026-02-28T23:30:00Z
...
**Addressed by decree-037.** Ruling: Skill ranks come from Edge slots only (PTU RAW). The automatic `skillRanksGained: 1` per level is removed. Implementation ticket: ptu-rule-127.
