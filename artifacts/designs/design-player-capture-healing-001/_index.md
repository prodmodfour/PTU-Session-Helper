...
| 2026-03-02 | P2 | Fix cycle | ecffe372..79e3f1f6 (4 commits) | code-review-288 fixes: app-surface.md updated (HIGH-1), panel mutual exclusion via closeAllPanels/togglePanel (HIGH-2), cancel button emitting cancel event (MED-1), redundant healTargets condition removed (MED-2). |
