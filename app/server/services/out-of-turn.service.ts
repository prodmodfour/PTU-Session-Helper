 ...
 *
 * Central service for out-of-turn action mechanics:
 ...
 *
 * P2 Intercept logic (Melee/Ranged) has been extracted to intercept.service.ts.
 *
...
// ============================================
// RE-EXPORTS FROM INTERCEPT SERVICE (P2)
// ============================================
// Intercept logic extracted to intercept.service.ts for file size compliance.
...
export {
  ...
  canInterceptMove,
  detectInterceptMelee,
  detectInterceptRanged,
  calculatePushDirection,
  resolveInterceptMelee,
  resolveInterceptRanged,
} from '~/server/services/intercept.service'

export type {
  InterceptMeleeDetectionParams,
  InterceptRangedDetectionParams,
} from '~/server/services/intercept.service'
