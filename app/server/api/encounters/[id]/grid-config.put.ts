  ...
  try {
    ...
    const updated = await prisma.encounter.update({
      ...
      data: {
        ...
        gridIsometric: body.isometric ?? encounter.gridIsometric ?? false,
        gridCameraAngle: body.cameraAngle ?? encounter.gridCameraAngle ?? 0,
        gridMaxElevation: body.maxElevation ?? encounter.gridMaxElevation ?? 5,
      }
    })
    ...
    const gridConfig: GridConfig = {
      ...
      isometric: updated.gridIsometric ?? false,
      cameraAngle: (updated.gridCameraAngle ?? 0) as 0 | 1 | 2 | 3,
      maxElevation: updated.gridMaxElevation ?? 5,
    }
