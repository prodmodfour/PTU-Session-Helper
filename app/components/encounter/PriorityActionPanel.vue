...
const { priorityEligibleCombatants } = useOutOfTurnState()
...
/**
 * Eligible combatants from composable (MED-005, refactoring-117).
 ...
 */
const eligibleCombatants = priorityEligibleCombatants
