...
import { useTouchInteraction, TOUCH_TAP_THRESHOLD } from '~/composables/useTouchInteraction'
import { useSelectionStore } from '~/stores/selection'
import { useMeasurementStore } from '~/stores/measurement'
import { useFogOfWarStore } from '~/stores/fogOfWar'
import { useTerrainStore } from '~/stores/terrain'

// Re-export TOUCH_TAP_THRESHOLD so existing imports from this module still work
export { TOUCH_TAP_THRESHOLD }
...
export function useGridInteraction(options: UseGridInteractionOptions) {
  ...
  // --- Touch interaction (delegated to shared composable) ---
  ...
  const touch = useTouchInteraction({
    ...
    onTap: (screenX: number, screenY: number) => {
